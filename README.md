...
launches the app. Sign in to Claude in the first-launch modal and you're done.
...
> Upgrading from Claude Code Studio v3.x? It's an in-place upgrade and settings
...
Node + the Claude CLI for you, so there are no manual prereqs.
...
2. Run it and follow the NSIS installer (you can choose the install
   ...
   UI. ~30 seconds total. You don't need to set up anything else.
